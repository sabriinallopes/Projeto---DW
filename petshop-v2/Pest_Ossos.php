...
<body>
    ...
    <br>
        ...
        <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
              <div class="carousel-item active">
                <img src="https://royalpets.vteximg.com.br/arquivos/ids/238907/Cachorro_-_Ossinhos_e_Petiscos_categoria.png?v=637695717823700000" class="d-block w-100" alt="...">
              </div>
            </div>
          </div>
        <!--FIM CARROSSEL-->
        ...
        <ul class="breadcrumb">
            ...
            <li><a href="Pest_Ossos.html"></a>Pestiscos e Ossos</li>
        </ul>
        <!--FIM MIGALHA DE PÃO-->
        ...
        <?php
            ...
            $consulta=$conexao->query("SELECT * FROM tbproduto WHERE idEspecie = 1 && idCategoriaProduto = 2");
        ...
        <section class="produtos">
            <h5 class="produtosracao">Pesticos para Cachorros</h5>
