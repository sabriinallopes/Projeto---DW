        ...
        <section class="produtos">
            ...
            <div class="product-container">
                ...
                <div class="product-image">
                      ...
                      <?php
                      echo ("<a href='descricaoProduto.php?id=$coluna[idProduto]'><button class='card-btn'>Saiba mais</button></a>");
                        echo ("<a href='carrinho.php?id=$coluna[idProduto]'><button>Adicionar ao carrinho</button></a>");
                       ?> 
                    </div>
