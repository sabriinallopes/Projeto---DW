...
<body>
    ...
    <br>
        ...
        <div id="carouselExampleControlsNoTouching" class="carousel slide" data-bs-touch="false"
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="https://royalpets.vteximg.com.br/arquivos/ids/157620/Banner---Categoria---gato-4.png?v=637487387647770000"
        ...
        <ul class="breadcrumb">
            ...
            <li><a href="racaoGatos.html"></a>Ração</li>
        </ul>
        <!--FIM MIGALHA DE PÃO-->
                ...
                <div class="product-card">
                    <div class="product-image">
                     <img src="./src/<?php echo $coluna['imagem']?>" class="product-thumb"
                            alt="Ração Premier Fórmula para Cães Sênior de Porte Grande e Gigante Sabor Frango 15kg">
