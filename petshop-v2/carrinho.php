...
<body>
    ...
    <div class="container-fluid">
                ...
                <section>
                    <?php
                        ...
                        while($coluna = $consulta->fetch(PDO::FETCH_ASSOC)){
                            ...
                            $nome = $coluna['nomeProduto'];
                            $descricao = $coluna['descProduto'];
                            $peso = $coluna['pesoProduto'];
                            $valor = $coluna['valorProduto'];
                            $imagem = $coluna['imagem'];   
                            
                        } ?>

                        <div class="imagemProduto">
                            <img src='./src/<?php echo $imagem?>'>
                        </div>

                    <form method="POST" action="./php/cadastro_venda.php">
                        <div class="informacoes">
                        <div name="id" id="id">
                                <?php echo $id?>  
                            </div> 
                            <div name="nome" id="nome">
                                <?php echo $nome?>  
                            </div>   
                            <div id="descricao">
                                <?php echo $descricao?>  
       ...
       <button type="button" class="btnCompra">Finalizar Pedido</button>
